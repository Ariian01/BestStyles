    ...
    <body>
       <div class="navbar navbar-fixed-top">
        ...
        <div class="footer span-12">
            <div class="container">
              <center> <b class="copyright"><a href="https://gitlab.com/prof.fabian.lopez/datatablearchivosplanoscrud.git"> EDI II</a> &copy; <?php echo date("Y")?> DataTables Bootstrap </b></center>
            </div>
        </div>
